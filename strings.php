<?php
	$searchtip = "<p>Enter exact string or its fragment, e.g. <i><u>analy</u></i> for all entries like <i><u>analy</u></i>sis, <i><u>analy</u></i>tical etc.<br> 
Search in column Title, Author, Publisher, Series, Periodicsl, MD5</p>";
	$str_prev = "&lt; &lt; &lt; PREV";
	$str_next = "NEXT &gt; &gt; &gt;";
	$str_pp_ru = "стр.";
	$str_pp_en = "pp.";
