...
if (!$_POST['Edit']) {
	...
	@$h = fopen($file, 'r');
	if (!$h)
		die("Cannot open temporary file '" . $file . "'");
	if (!flock($h, LOCK_EX))
		die("<p>Cannot lock temporary file '" . $file . "'");
...
// UNLOCK DB
echo $htmlhead . "<font color='#A00000'><h1>" . $LANG_MESS_151 . "</h1></font> " . $LANG_MESS_152 . "<br>
<font face='courier new'><b>" . $_POST[MD5] . "</b></font><p><h2>" . $LANG_MESS_149 . "</h2>
<a href='registration.php'>" . $LANG_MESS_150 . "</a><br>
<a href='..'>" . $LANG_MESS_148 . "</a><br>
<a href='../book/index.php?md5=" . $_POST[MD5] . "'>" . $LANG_MESS_147 . "</a><br>
<a href='../last.php'>" . $LANG_MESS_156 . "</a><br>
<font color = '#A00000'><b>" . $LANG_MESS_105 . "</b></font>
" . $htmlfoot;
